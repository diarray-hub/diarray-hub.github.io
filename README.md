...
Hi, I'm Yacouba Diarra (**diarray** on the internet) and I care about stuffs like having a [blog](./blog.md) to post about, well... [stuffs](https://diarray-hub.github.io/misc/stuffs/2026/01/13/stuff.html). By the way this website was created with [markdown](https://docs.github.com/en/pages/setting-up-a-github-pages-site-with-jekyll/creating-a-github-pages-site-with-jekyll), what a great framework to create a [motherfucking website](https://motherfuckingwebsite.com/)!
